...
setwd("/home/saikiran/supervised_clustering/code/newcode/expt3")
...
index = sample(1:nrow(misplaced_label_data), nrow(misplaced_label_data)/10)
...
#plottings
all_files = list.files("/home/saikiran/supervised_clustering/code/newcode/expt3/NNdata",full.names = T, pattern = "NN")
