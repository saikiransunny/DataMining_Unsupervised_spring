...
setwd("/home/saikiran/supervised_clustering/code/newcode/expt1")
...
outlier_dataset[index,]$meanfreq = sample(10:15, nrow(outlier_dataset)/10, replace = T)
...
#plottings
all_files = list.files("/home/saikiran/supervised_clustering/code/newcode/expt1/NNdata",full.names = T, pattern = "NN")
